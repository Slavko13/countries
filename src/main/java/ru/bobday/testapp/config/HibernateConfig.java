...
@EnableJpaRepositories(basePackages = "ru.bobday.testapp.repository", entityManagerFactoryRef = "entityManagerFactoryBean")
public class HibernateConfig {

    private static final String ENTITY_PACKAGE = "ru.bobday.testapp.domain";
